function [x,fval,output,population,scores] = modcell_design_w_initial_pop_given(prodnet,cand,max_deletions,max_additions,objective,min_growth_rate,pop_size,ngen,starting_beta,max_time,initial_population)
