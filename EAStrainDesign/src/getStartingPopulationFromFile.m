function initial_population = getStartingPopulationFromFile(file,sep,node,prodnet,cand,pop_size,max_deletions,max_additions)
...
for i = 1:n_rows
    ...
    if sum(strcmp(node_i,node)) ~= 0
        del_rxns = strsplit(char(m{i,3}),sep);
